...
| :--- | :--- | :--- |
| *C* | *RegistrationPage* | *Antarmuka registrasi akun bagi pelajar (Boundary)* |
| *C* | *AuthController* | *Mengatur proses registrasi dan validasi data akun (Control)* |
| *C* | *Pengguna* | *Menyimpan data akun pengguna seperti email, password, dan role (Entity)* |
| *C* | *Pelajar* | *Menyimpan data pelajar yang melakukan registrasi (Entity)* |
| *C* | *OrangTuaWali* | *Menyimpan data orang tua/wali yang terhubung dengan akun pelajar (Entity)* |
| *C* | *TenagaKesehatan* | *Menyimpan data tenaga kesehatan yang terhubung dengan akun pelajar (Entity)* |
| *C* | *RiwayatKesehatan* | *Menyimpan data riwayat kesehatan yang diisi saat registrasi (Entity)* |
