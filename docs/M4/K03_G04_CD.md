...
| *C13* | *RegistrasiPage* | *Merepresentasikan antarmuka formulir registrasi akun bagi pelajar (Boundary Class).* | *UC01* |
...
| *C33* | *NotifikasiDaruratPopup* | *Merepresentasikan antarmuka pop-up yang menampilkan detail notifikasi darurat serta menyediakan aksi konfirmasi penerimaan dan tindak lanjut (Boundary Class).* | *UC08* |
...
| :--- | :--- | :--- |
| *C13* | *RegistrationPage* | *Antarmuka registrasi akun bagi pelajar (Boundary Class)* |
...
| :--- | :--- | :--- | :--- |
| *C13* | *RegistrasiPage* | *inputDataPelajar, inputDataWali* | *displayFormRegistrasi(), inputDataPelajar(), inputDataWali(), submitRegistrasi()* |
| *C14* | *AuthController* | *-* | *validateData(), registerAccount()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C15* | *KonfirmasiRegistrasiPage* | *Antarmuka konfirmasi registrasi akun bagi pengguna (Boundary Class)* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C15* | *KonfirmasiRegistrasiPage* | *dataRegistrasi, statusKonfirmasi* | *displayDataRegistrasi(), confirmRegistrasi()* |
| *C14* | *AuthController* | *-* | *validateConfirmation(), confirmAccount()* |
| *C02* | *Pelajar* | *-* | *-* |
| *C03* | *OrangTuaWali* | *-* | *-* |
| *C04* | *TenagaKesehatan* | *-* | *-* | 
| *C01* | *Pengguna* | *-* | *-* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C24* | *PengajuanKonsultasiPage* | *selectedTenagaKesehatan, filteredDate, displayedTenagaKesehatan, displayedSchedule* | *displayTenagaKesehatan(), selectTenagaKesehatan(), filterJenisTenagaKesehatan(), filterDate(), displayAvailableSchedule()* | 
...
| *C10* | *NotifikasiDarurat* | *statusKonfirmasi, waktuKonfirmasi, statusTindakLanjut, waktuTindakLanjut* | *recordConfirmation(), recordFollowUp()* |
| *C11* | *FasilitasKesehatan* | *idFasilitas, namaFasilitas, lokasi, estimasiBiaya* | *getLokasi(), getEstimasiBiaya()* |
| *C12* | *JadwalKonsultasi* | *idJadwal, tanggal, waktu, statusKetersediaan, statusPengajuan* | *, getDate(), getTime(), getStatus(), updateAvailability(), updateStatus()* |
| *C13* | *RegistrasiPage* | *inputDataPelajar, inputDataWali* | *displayFormRegistrasi(), inputDataPelajar(), inputDataWali(), submitRegistrasi()* |
| *C14* | *AuthController* | *currentUser* | *validateData(), registerAccount(), login(), Logout(), validateConfirmation(), confirmAccount()* |
| *C15* | *KonfirmasiRegistrasiPage* | *dataRegistrasi, statusKonfirmasi* | *displayDataRegistrasi(), confirmRegistrasi()* |
| *C16* | *CheckInPage* | *moodInput, sleepDurationInput, dietInput, triggerInput, reflectionInput* | *showPage(), getInput(), showError(), showSuccessMessage()* |
| *C17* | *CheckInController* | *currentCheckIn* | *submitCheckIn(), validateCheckInFormat(), encryptJournal()* |
| *C18* | *NotificationController* | *reminderSchedule, status* | *sendDailyReminder(), checkPendingCheckIn()* |
...
| *C22* | *ProfilTenagaKesehatanPage* | *tenagaKesehatanDipilih* | *displayProfile(), displayAvailableSchedules()* |
| *C23* | *TenagaKesehatanController* | *-* | *loadTenagaKesehatan(), processLocationPermission(), calculateDistances(), selectTenagaKesehatan()* |
| *C24* | *PengajuanKonsultasiPage* | *selectedTenagaKesehatan, filteredDate, displayedTenagaKesehatan, displayedSchedule, jadwalDipilih, dataPengajuan* | *displayForm(), displaySelectedSchedule(), showUnavailableWarning(), getFormData(), displayTenagaKesehatan(), filterDate(), displayAvailableSchedule(), selectTenagaKesehatan(), filterJenisTenagaKesehatan()* |
| *C25* | *JadwalKonsultasiController* | *-* | *loadAvailableSchedules(), checkAvailability(), selectSchedule(), submitRequest()* |
| *C26* | *KonsultasiController* | *-* | *submitPengajuan(), cancelPengajuan(), approvePengajuan(), reschedule()* |
| *C27* | *NotifikasiDaruratController* | *-* | *sendEmergencyNotification(), loadEmergencyDetail(), confirmReceived(), markFollowUp()* |
| *C28* | *LoginPage* | *usernameOrEmailInput, passwordInput* | *showPage(), getInput(), showError()* |
...
| *C30* | *PasswordController* | *-* | *sendResetLink(), resetPassword()* |
| *C31* | *DashboardPage* | *currentUser* | *displayDashboard(), displayUserInfo()* |
 | *NotifikasiDaruratPopup* | *notifikasiAktif* | *showPopup(), displayDetail(), displayStatus()* |
| *C32* | *SettingPage* | *currentUser* | *showPage(), selectLogout()* |
| *C33* | *NotifikasiDaruratPopup* | *notifikasiAktif* | *showPopup(), displayDetail(), displayStatus()* |
...
| *C05* | *UC01* | *KF01* |
| *C06* | *UC01* | *KF01* |
| *C07* | *UC04, UC08* | *KFKF06, KF08, KF09, KF10, KF17, KF18, KF19, KF20, KF21* |
| *C08* | *UC03, UC08* | *KF03, KF04, KF05, KF07, KF18, KF19, KF20, KF21* |
| *C09* | *UC03* | *KFKF03, KF04, KF05, KF07* |
| *C10* | *UC08* | *KF18, KF19, KF20, KF21* |
| *C11* | *UC05* | *KF11, KF12* |
| *C12* | *UC06, UC07* | *KF13, KF14, KF15, KF16* |
| *C13* | *UC01* | *KF01* |
| *C14* | *UC01, UC09, UC10* | *KF01, KF22, KF23, KF24* |
| *C15* | *UC02* | *KF02* |
| *C16* | *UC03* | *KF03, KF04, KF05, KF07* |
| *C17* | *UC03* | *KF03, KF04, KF05, KF07* |
| *C18* | *UC03* | *KF03, KF04, KF05, KF07* |
| *C19* | *UC04* | *KF06, KF08, KF09, KF10, KF17* |
| *C20* | *UC04* | *KF06, KF08, KF09, KF10, KF17* |
| *C21* | *UC05* | *KF11, KF12* |
| *C22* | *UC05, UC06* | *KF11, KF12, KF13, KF14* |
| *C23* | *UC05* | *KF11, KF12* |
| *C24* | *UC06, UC07* | *KF13, KF14, KF15, KF16* |
| *C25* | *UC06* | *KF13, KF14* |
| *C26* | *UC07* | *KF15, KF16* |
| *C27* | *UC08* | *KF18, KF19, KF20, KF21* |
| *C28* | *UC09, UC10* | *KF22, KF23, KF24* |
| *C29* | *UC09* | *KF22, KF23* |
| *C30* | *UC09* | *KF22, KF23* |
| *C31* | *UC09* | *KF22, KF23* |
| *C32* | *UC10* | *KF24* |
| *C33* | *UC08* | *KF18, KF19, KF20, KF21* |
