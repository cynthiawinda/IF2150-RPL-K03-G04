...
| *C04* | *TenagaKesehatan* | *Merepresentasikan pengguna psikolog/psikiater yang dapat dipilih pelajar dari daftar rekomendasi, serta meninjau pengajuan jadwal konsultasi yang masuk.* | *UC05, UC06, UC07, UC09, UC10* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C* | *KonfirmasiRegistrasiPage* | *Antarmuka konfirmasi registrasi akun bagi orang tua/wali (Boundary)* |
| *C* | *AuthController* | *Mengatur proses konfirmasi dan perubahan status registrasi akun (Control)* |
| *C* | *Pelajar* | *Menyimpan data pelajar yang akun registrasinya akan dikonfirmasi (Entity)* |
| *C* | *OrangTuaWali* | *Menyimpan data orang tua/wali yang melakukan konfirmasi registrasi (Entity)* |
| *C* | *Pengguna* | *Menyimpan status akun yang sedang dalam proses konfirmasi (Entity)* |
...
| *CXX* | *CheckInPage* | *Antarmuka formulir pengisian _daily check-in_ bagi pelajar (_Boundary Class_).* |
| *CXX* | *CheckInController* | *Mengatur proses penerimaan masukan, validasi format, dan penyimpanan data _check-in_ (_Controller Class_).* |
| *CXX* | *NotificationController* | *Mengatur penjadwalan dan pengiriman notifikasi pengingat harian ke peramban pengguna (_Controller Class_).* |
...
| *CXX* | *CheckInPage* | *moodInput, sleepDurationInput, dietInput, triggerInput, reflectionInput* | *showPage(), getInput(), showError(), showSuccessMessage()* |
| *CXX* | *CheckInController* | *currentCheckIn* | *submitCheckIn(), validateCheckInFormat(), encryptJournal()* |
| *CXX* | *NotificationController* | *reminderSchedule, status* | *sendDailyReminder(), checkPendingCheckIn()* |
...
| *CXX* | *ReportPage* | *Antarmuka visualisasi grafik statistik, tren mingguan/bulanan, dan rangkuman kondisi (_Boundary Class_).* |
| *CXX* | *ReportController* | *Mengatur kalkulasi data statistik, pembuatan grafik, pembatasan filter privasi wali, serta evaluasi ambang batas (_Controller Class_).* |
...
| *CXX* | *ReportPage* | *selectedPeriod, displayedChart, displayedSummary* | *showPage(), displayChart(), filterViewByRole()* |
| *CXX* | *ReportController* | *currentReport* | *calculateStatistics(), buildTrendChart(), applyPrivacyRestriction()* |
...
| *CXX* | *CariTenagaKesehatanPage* | *Merepresentasikan antarmuka pencarian tenaga kesehatan yang menampilkan daftar tenaga kesehatan, lokasi fasilitas kesehatan, estimasi biaya konsultasi, dan informasi jarak (Boundary Class).* |
| *CXX* | *ProfilTenagaKesehatanPage* | *Merepresentasikan antarmuka untuk menampilkan profil tenaga kesehatan yang dipilih pelajar (Boundary Class).* |
| *CXX* | *TenagaKesehatanController* | *Mengatur proses pencarian tenaga kesehatan, pemrosesan izin akses lokasi, perhitungan jarak ke fasilitas kesehatan, dan pemilihan tenaga kesehatan (Controller Class).* |
...
| *CXX* | *CariTenagaKesehatanPage* | *-* | *showPage(), requestLocationPermission(), displayResults()* |
| *CXX* | *ProfilTenagaKesehatanPage* | *tenagaKesehatanDipilih* | *displayProfile()* |
| *CXX* | *TenagaKesehatanController* | *-* | *loadTenagaKesehatan(), processLocationPermission(), calculateDistances(), selectTenagaKesehatan()* |
...
| *CXX* | *ProfilTenagaKesehatanPage* | *Merepresentasikan antarmuka profil tenaga kesehatan yang menampilkan jadwal konsultasi yang tersedia (Boundary Class).* |
| *CXX* | *PengajuanKonsultasiPage* | *Merepresentasikan antarmuka formulir pengajuan konsultasi serta jadwal yang dipilih oleh pelajar (Boundary Class).* |
| *CXX* | *JadwalKonsultasiController* | *Mengatur proses pemuatan jadwal, pengecekan dan pembaruan ketersediaan, pemilihan jadwal, serta pengiriman pengajuan konsultasi (Controller Class).* |
...
| *CXX* | *ProfilTenagaKesehatanPage* | *tenagaKesehatanDipilih* | *displayProfile(), displayAvailableSchedules()* |
| *CXX* | *PengajuanKonsultasiPage* | *jadwalDipilih, dataPengajuan* | *displayForm(), displaySelectedSchedule(), showUnavailableWarning(), getFormData()* |
| *CXX* | *JadwalKonsultasiController* | *-* | *loadAvailableSchedules(), checkAvailability(), selectSchedule(), submitRequest()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C* | *PengajuanKonsultasiPage* | *Antarmuka bagi tenaga kesehatan untuk melihat dan mengelola pengajuan konsultasi (Boundary)* |
| *C* | *KonsultasiController* | *Mengatur proses pengelolaan pengajuan konsultasi, termasuk persetujuan dan perubahan jadwal (Control)* |
| *C* | *JadwalKonsultasi* | *Menyimpan data pengajuan jadwal konsultasi beserta statusnya (Entity)* |
| *C* | *Pelajar* | *Menyimpan data pelajar yang mengajukan konsultasi (Entity)* |
| *C* | *TenagaKesehatan* | *Menyimpan data tenaga kesehatan yang menerima dan meninjau pengajuan konsultasi (Entity)* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C* | *PengajuanKonsultasiPage* | *selectedTenagaKesehatan, selectedDate, displayedTenagaKesehatan, displayedSchedule* | *displayTenagaKesehatan(), selectTenagaKesehatan(), filterJenisTenagaKesehatan(), selectDate(), displayAvailableSchedule()* | 
| *C* | *KonsultasiController* | *-* | *submitPengajuan(), cancelPengajuan(), approvePengajuan(), reschedule()* |
| *C* | *JadwalKonsultasi* | *idJadwal, tanggal, waktu, status* | *getDate(), getTime(), getStatus(), updateStatus(), updateSchedule()* |
| *C* | *Pelajar* | *idPelajar, nama* | *-* |
| *C* | *TenagaKesehatan* | *idTenagaKesehatan, nama, jenisTenagaKesehatan, lokasi* | *-* | 
...
| *CXX* | *NotifikasiDaruratPopup* | *Merepresentasikan antarmuka pop-up yang menampilkan detail notifikasi darurat serta menyediakan aksi konfirmasi penerimaan dan tindak lanjut (Boundary Class).* |
| *CXX* | *NotifikasiDaruratController* | *Mengatur pengiriman notifikasi darurat, pengambilan detail kondisi darurat, pencatatan konfirmasi penerimaan, dan pencatatan tindak lanjut (Controller Class).* |
...
| *CXX* | *NotifikasiDaruratPopup* | *notifikasiAktif* | *showPopup(), displayDetail(), displayStatus()* |
| *CXX* | *NotifikasiDaruratController* | *-* | *sendEmergencyNotification(), loadEmergencyDetail(), confirmReceived(), markFollowUp()* |
...
| *CXX* | *LoginPage* | *Merepresentasikan antarmuka login untuk pengguna serta fitur lupa password (Boundary Class)* |
| *CXX* | *AuthController* | *Mengatur autentikasi pengguna, validasi kredensial, status verifikasi, dan sesi login (Controller Class)* |
| *CXX* | *ResetPasswordPage* | *Merepresentasikan antarmuka untuk memasukkan e-mail dan password baru (Boundary Class)* |
| *CXX* | *PasswordController* | *Mengatur reset password, termasuk pengiriman tautan reset (Controller Class)* |
| *CXX* | *DashboardPage* | *Merepresentasikan antarmuka halaman utama setelah pengguna berhasil masuk akun (Boundary Class)* |
...
| *CXX* | *LoginPage* | *usernameOrEmailInput, passwordInput* | *showPage(), getInput(), showError()* |
| *CXX* | *AuthController* | *currentUser* | *login()* |
| *CXX* | *ResetPasswordPage* | *emailInput, newPasswordInput, confirmPasswordInput* | *showPage(), getInput(), showError()* |
| *CXX* | *PasswordController* | *-* | *sendResetLink(), resetPassword()* |
| *CXX* | *DashboardPage* | *currentUser* | *displayDashboard(), displayUserInfo()* |
...
| *CXX* | *SettingPage* | *Merepresentasikan antarmuka halaman pengaturan/profil yang menyediakan opsi keluar akun (Boundary Class)* |
| *CXX* | *AuthController* | *Mengatur proses keluar akun dan mengakhiri sesi login pengguna (Controller Class)* |
| *CXX* | *LoginPage* | *Merepresentasikan antarmuka login kembali untuk pengguna setelah berhasil keluar akun (Boundary Class)* |
...
| *CXX* | *SettingPage* | *currentUser* | *showPage(), selectLogout()* |
| *CXX* | *AuthController* | *currentUser* | *logout()* |
| *CXX* | *LoginPage* | *usernameOrEmailInput, passwordInput* | *showPage()* |
