...
| :--- | :--- | :--- |
| *C01* | *Pengguna* | *Menyimpan data akun pengguna yang terdaftar pada sistem.* |
| *C02* | *Pelajar* | *Menyimpan data pelajar yang melakukan registrasi akun.* |
| *C03* | *OrangTuaWali* | *Menyimpan data orang tua/wali yang terhubung dengan akun pelajar.* |
| *C05* | *RiwayatKesehatan* | *Menyimpan data riwayat kesehatan dan kontak orang tua/wali yang diisi saat registrasi akun.* |
| *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Pengguna* | *Menyimpan data akun pelajar yang akan dikonfirmasi.* |
| *C02* | *Pelajar* | *Menyimpan data pelajar yang akun registrasinya akan dikonfirmasi.* |
| *C03* | *OrangTuaWali* | *Menyimpan data orang tua/wali yang melakukan konfirmasi registrasi akun pelajar.* |
| *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *Pelajar* | *Menyimpan identitas pelajar yang melakukan pengisian pencatatan harian (_daily check-in_).* |
| *C06* | *CheckIn* | *Kelas entitas utama yang menyimpan data harian pelajar meliputi tanggal, skala _mood_, jam tidur, jam bangun, pola makan, pemicu stres, dan catatan refleksi.* |
| *C08* | *Notifikasi* | *Kelas abstrak yang mendefinisikan struktur pesan notifikasi pengingat harian.* |
| *C09* | *Notifikasi pengingat* | *Kelas turunan notifikasi yang mengirimkan pengingat otomatis jika pelajar belum melakukan _check-in_ pada jam yang ditentukan.* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *Pelajar* | *Merepresentasikan pelajar yang mengakses dasbor statistik personal dan laporan kondisi kesehatannya.* |
| *C03* | *OrangTuaWali* | *Merepresentasikan wali yang melihat visualisasi grafik rangkuman tanpa akses ke catatan refleksi pribadi.* |
| *C06* | *CheckIn* | *Menyediakan kumpulan data histori _daily check-in_ yang akan diolah menjadi grafik dan statistik.* |
| *C07* | *LaporanKesehatan* | *Mengolah himpunan data _check-in_ menjadi grafik statistik mingguan/bulanan, menghitung rata-rata _mood_/tidur, serta mengevaluasi ambang batas kondisi darurat.* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C02* | *Pelajar* | *Menyimpan data pelajar yang mengajukan konsultasi dengan tenaga kesehatan.* |
| *C04* | *TenagaKesehatan* | *Menyimpan data tenaga kesehatan yang dipilih untuk konsultasi.* |
| *C12* | *JadwalKonsultasi* | *Menyimpan data pengajuan jadwal konsultasi antara pelajar dan tenaga kesehatan beserta statusnya.* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Pengguna* | *Kelas abstrak yang menyimpan data akun (identitas diri, email, password) yang dimiliki oleh ketiga aktor, serta alur login dan logout.* |
| *C02* | *Pelajar* | *Merepresentasikan pengguna pelajar yang melakukan registrasi, check-in harian, melihat statistik kondisi kesehatannya, serta menentukan jadwal konsultasi dengan tenaga kesehatan.* |
| *C03* | *OrangTuaWali* | *Merepresentasikan pengguna orang tua/wali yang mengonfirmasi registrasi akun pelajar di bawah umur, memantau laporan kondisi pelajar, serta menerima dan menindaklanjuti notifikasi darurat.* |
| *C04* | *TenagaKesehatan* | *Merepresentasikan pengguna psikolog/psikiater yang dapat dipilih pelajar dari daftar rekomendasi, serta meninjau pengajuan jadwal konsultasi yang masuk.* |
...
Diagram kelas UC09 memuat empat kelas yang dihubungkan dengan satu jenis relasi, yaitu **generalisasi**. Kelas C01 Pengguna adalah kelas abstrak yang menjadi induk, sedangkan C02 Pelajar, C03 OrangTuaWali, dan C04 TenagaKesehatan adalah kelas turunan yang mewarisi atribut dan metode/operasi Pengguna. Relasi ini dipilih karena ketiga aktor masuk ke sistem dengan cara yang sama, yaitu memasukkan username/e-mail dan password, divalidasi, dicek status akunnya, dan dapat mengganti password jika lupa. Perbedaan ketiganya hanya pada dashboard tujuan setelah berhasil masuk, sehingga metode tampilkanDashboard() dideklarasikan abstrak pada Pengguna dan diimplementasikan ulang oleh masing-masing kelas turunan.

| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Pengguna* | *idPengguna, username, email, password, statusAkun, sesiAktif* | *login(), validasiKredensial(), cekStatusAkun(), kirimTautanReset(), resetPassword(), tampilkanDashboard()* |
| *C02* | *Pelajar* | *-* | *tampilkanDashboard()* |
| *C03* | *OrangTuaWali* | *-* | *tampilkanDashboard()* |
| *C04* | *TenagaKesehatan* | *-* | *tampilkanDashboard()* |
...
Diagram kelas UC10 memuat empat kelas yang dihubungkan dengan satu jenis relasi, yaitu **generalisasi**. Kelas C01 Pengguna adalah kelas abstrak yang menjadi induk, sedangkan C02 Pelajar, C03 OrangTuaWali, dan C04 TenagaKesehatan adalah kelas turunan yang mewarisi atribut dan metode/operasi Pengguna. Relasi ini dipilih karena ketiga aktor keluar dari sistem dengan cara yang sama, yaitu memilih menu keluar akun, mengonfirmasi keluar, lalu sesi login diakhiri dan pengguna dialihkan ke halaman masuk. Karena itu, atribut sesiAktif serta metode logout() dan akhiriSesi() cukup dideklarasikan pada Pengguna dan diwarisi oleh ketiga kelas turunan.

| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Pengguna* | *sesiAktif* | *logout(), akhiriSesi()* |
| *C02* | *Pelajar* | *-* | *-* |
| *C03* | *OrangTuaWali* | *-* | *-* |
| *C04* | *TenagaKesehatan* | *-* | *-* |
