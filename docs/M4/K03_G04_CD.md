...
| :--- | :--- | :--- |
| *C01* | *Pelajar* | *Menyimpan data akun pelajar yang terdaftar pada sistem.* |
| *C02* | *Pesanan* | *Menyimpan data akun wali yang terhubung dengan pelajar.* |
| *C03* | *Akun* | *Menyimpan informasi kredensial pengguna untuk mengakses sistem.* |
| *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Akun* | *Menyimpan informasi akun yang sedang dalam proses registrasi dan konfirmasi.* |
| *C02* | *Pelajar* | *Menyimpan data pengguna yang sedang melakukan konfirmasi registrasi akun.* |
| *C03* | *KonfirmasiRegistrasi* | *Menyimpan informasi konfirmasi registrasi akun.* |
| *...* | *...* | *...* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C01* | *Pelajar* | *Menyimpan data pelajar yang mengajukan konsultasi dengan tenaga kesehatan.* |
| *C02* | *TenagaKesehatan* | *Menyimpan data tenaga kesehatan yang dipilih untuk konsultasi.* |
| *C03* | *Konsultasi* | *Menyimpan data pengajuan konsultasi yang dibuat oleh pelajar.* |
| *C04* | *JadwalKonsultasi* | *Menyimpan informasi jadwal konsultasi yang diajukan oleh pelajar.* |
