...
| *CXX* | *NotifikasiDaruratPage* | *Merepresentasikan antarmuka untuk menampilkan detail notifikasi darurat serta status konfirmasi dan tindak lanjut (Boundary Class).* |
...
| *CXX* | *NotifikasiDaruratPage* | *notifikasiAktif* | *displayDetail(), displayStatus()* |
