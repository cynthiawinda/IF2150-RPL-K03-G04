...
| :--- | :--- | :--- |
| *C* | *RegistrationPage* | *Antarmuka registrasi akun bagi pelajar (Boundary Class)* |
| *C* | *AuthController* | *Mengatur proses registrasi dan validasi data akun (Control Class)* |
| *C* | *Pengguna* | *Menyimpan data akun pengguna seperti email, password, dan role (Entity Class)* |
| *C* | *Pelajar* | *Menyimpan data pelajar yang melakukan registrasi (Entity Class)* |
| *C* | *OrangTuaWali* | *Menyimpan data orang tua/wali yang terhubung dengan akun pelajar (Entity Class)* |
| *C* | *TenagaKesehatan* | *Menyimpan data tenaga kesehatan yang terhubung dengan akun pelajar (Entity Class)* |
| *C* | *RiwayatKesehatan* | *Menyimpan data riwayat kesehatan yang diisi saat registrasi (Entity Class)* |
...
| :--- | :--- | :--- | :--- |
| *C* | *RegistrationPage* | *inputDataPelajar, inputDataWali* | *displayFormRegistration(), inputDataPelajar(), inputDataWali(), submitRegistrasi()* |
| *C* | *AuthController* | *-* | *validateData(), registerAccount()* |
| *C* | *Pengguna* | *idPengguna, email, password* | *-* |
| *C* | *Pelajar* | *nama, tanggalLahir, nomorTelepon* | *-* |
| *C* | *OrangTuaWali* | *idWali, nama, email, nomorTelepon* | *-* |
| *C* | *TenagaKesehatan* | *nama, email, nomorTelepon, jenisTenagaKesehatan, lokasi* | *-* |
| *C* | *RiwayatKesehatan* | *riwayatKesehatan* | *-* |
