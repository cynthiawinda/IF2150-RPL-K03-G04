...
| No | Aksi Aktor                                         | Reaksi Perangkat Lunak                                                                                                 |
| :- | :------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------- |
| 1  | *Pelajar membuka fitur pencarian tenaga kesehatan* | *Sistem menampilkan daftar tenaga kesehatan beserta lokasi dan estimasi biaya konsultasi*                              |
...
| :- | :----------------------------------------------------- | :------------------------------------------------------------------------------------------- |
| 1  | *Pelajar membuka fitur pencarian tenaga kesehatan*     | *Sistem menampilkan daftar tenaga kesehatan beserta lokasi dan estimasi biaya konsultasi*    |
| 2  | *Pelajar tidak memberikan izin akses lokasi perangkat* | *Sistem tetap menampilkan daftar tenaga kesehatan tanpa informasi jarak dari lokasi pelajar* |
| 3  | *Pelajar memilih salah satu tenaga kesehatan*          | *Sistem menampilkan profil tenaga kesehatan yang dipilih*                                    |
...
| No | Aksi Aktor                                                   | Reaksi Perangkat Lunak                                                                     |
| :- | :----------------------------------------------------------- | :----------------------------------------------------------------------------------------- |
| 1  | *Pelajar membuka profil tenaga kesehatan yang telah dipilih* | *Sistem menampilkan profil tenaga kesehatan dan jadwal konsultasi yang tersedia*           |
| 2  | *Pelajar memilih jadwal konsultasi*                          | *Sistem menampilkan formulir pengajuan jadwal konsultasi sesuai jadwal yang dipilih*       |
| 3  | *Pelajar mengisi formulir pengajuan jadwal konsultasi*       | *Sistem menampilkan kembali data pengajuan yang telah diisi*                               |
| 4  | *Pelajar mengirimkan pengajuan jadwal konsultasi*            | *Sistem menyimpan pengajuan dan mengirimkannya kepada tenaga kesehatan untuk dikonfirmasi* |
...
| :- | :----------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1  | *Pelajar membuka profil tenaga kesehatan yang telah dipilih* | *Sistem menampilkan profil tenaga kesehatan dan jadwal konsultasi yang tersedia*                                                                  |
| 2  | *Pelajar memilih jadwal konsultasi*                          | *Sistem memperbarui ketersediaan jadwal dan mendeteksi bahwa jadwal yang dipilih sudah tidak tersedia*                                            |
| 3  | *Pelajar memilih jadwal lain yang masih tersedia*            | *Sistem menampilkan formulir pengajuan jadwal konsultasi sesuai jadwal baru yang dipilih, kemudian alur dilanjutkan ke langkah 3 skenario normal* |
