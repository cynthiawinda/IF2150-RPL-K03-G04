...
| *UC09* | *Masuk Akun Pengguna* | *Jika sudah mendaftarkan akun, pelajar dapat masuk atau melakukan login dengan username/e-mail dan password.* | *Pelajar* | *...* |
| *UC10* | *Keluar Akun Pengguna* | *Jika sudah menyelesaikan segala aktivitasnya atau ingin berpindah akun, pelajar dapat memilih opsi keluar akun pengguna.* | *Pelajar* | *...* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pelajar mengetuk tombol untuk melihat kondisi kesehatannya* | *Sistem menampilkan statistik kondisi berdasarkan data daily check-in yang telah dicatat* |
| 2 | *Pelajar memilih periode statistik yang ingin dilihat* | *Sistem menampilkan statistik kondisi yang sesuai periode yang dipilih* |
| 3 | *Pelajar memilih suatu pola kondisi atau catatan refleksi yang ingin dilihat* | *Sistem menampilkan visualisasi dan informasi mengenai data yang dipilih* |
| 4 | *Pelajar memilih untuk melihat laporan kondisi.* | *Sistem menampilkan rangkuman kondisi kesehatan serta rekomendasi kesehatan berdasarkan data pada periode yang dipilih* |
...
| 2 | *Pelajar memilih jadwal konsultasi* | *Sistem menampilkan jadwal yang dipilih dan memperbarui ketersediaan jadwal tenaga kesehatan* |
...
| :--- | :--- | :--- |
| 1 | *Pelajar membuka profil tenaga kesehatan yang telah dipilih* | *Sistem menampilkan profil tenaga kesehatan dan formulir pengajuan konsultasi beserta jadwal yang tersedia* |
| 2 | *Pelajar memilih jadwal konsultasi* | *Sistem menampilkan jadwal yang dipilih pada formulir pengajuan konsultasi* |
| 3 | *-* | *Sistem memperbarui ketersediaan jadwal, mendeteksi bahwa jadwal yang dipilih sudah tidak tersedia, dan menampilkan jadwal terbaru yang masih tersedia* |
| 4 | *Pelajar memilih jadwal lain yang masih tersedia* | *Sistem menetapkan jadwal baru yang dipilih pada formulir pengajuan konsultasi* |
| 5 | *Pelajar mengisi formulir pengajuan konsultasi* | *Sistem memperbarui dan menampilkan ketersediaan jadwal terbaru selama formulir dibuka* |
| 6 | *Pelajar mengirimkan pengajuan jadwal konsultasi* | *Sistem menyimpan pengajuan untuk ditinjau oleh tenaga kesehatan* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Tenaga kesehatan membuka halaman jadwal konsultasi* | *Sistem menampilkan daftar pengajuan konsultasi yang masuk beserta detail dan tombol aksi (Setujui/Reschedule)* |
...
| 2 | *Pelajar memasukkan username/e-mail dan password yang terdaftar, lalu menekan tombol masuk* | *Sistem memvalidasi kecocokan kredensial dengan data akun, lalu mengarahkan pelajar ke halaman utama (dashboard)* |
...
| :--- | :--- | :--- |
| 1 | *Pelajar memilih menu masuk akun (log in)* | *Sistem menampilkan kolom masukan username/e-mail dan password* |
| 2 | *Pelajar memasukkan username/e-mail dan password yang salah, lalu menekan tombol masuk* | *Sistem mendeteksi kredensial tidak cocok, menampilkan pesan kesalahan, dan meminta pelajar memasukkan kembali* |
| 3 | *Pelajar memasukkan ulang username/e-mail dan password yang benar* | *Sistem memvalidasi kecocokan kredensial dengan data akun, lalu mengarahkan pelajar ke halaman utama (dashboard)* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pelajar memilih menu keluar akun (log out) pada halaman pengaturan/profil* | *Sistem menampilkan pop up konfirmasi keluar akun* |
| 2 | *Pelajar menekan tombol konfirmasi keluar* | *Sistem mengakhiri sesi login pelajar dan mengarahkan kembali ke halaman masuk* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pelajar memilih menu keluar akun (log out) pada menu pengaturan/profil* | *Sistem menampilkan pop up konfirmasi keluar akun* |
| 2 | *Pelajar menekan tombol batal* | *Sistem menutup konfirmasi dan mempertahankan sesi login pelajar, kembali pada halaman pengaturan/profil* |
