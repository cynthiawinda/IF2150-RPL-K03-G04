...
| *B* | *Merubah aktor Mahasiswa menjadi Pelajar, merubah deskripsi aktor-aktor sehingga lebih singkat, padat, dan jelas, merubah urutan user story dan isi nilai/tujuannya, dan merubah isi pada bagian deskripsi aktivitas* |
| *C* | |
| ... | |
...
| US-05 | *Pelajar* | *Mendapatkan rekomendasi tenaga kesehatan* | *Menemukan tenaga profesional yang sesuai dengan kebutuhan dan preferensi* |
| US-06 | *Pelajar* | *Menjadwalkan konsultasi dengan tenaga kesehatan* | *Memperoleh kepastian waktu konsultasi dengan tenaga profesional* |
...
| A06 | *Menjadwalkan Konsultasi* | *Pelajar memilih tenaga kesehatan dan menentukan jadwal konsultasi melalui sistem, dengan tenaga kesehatan yang direkomendasikan ditampilkan sebagai sorotan utama* | *US-05 & US-06* |
| A07 | *Menghubungi Layanan Darurat* | *Pelajar menghubungi layanan darurat melalui web ketika mengalami kondisi darurat* | *US-07* |
| A08 | *Melihat Rekam Kondisi Kesehatan* | *Tenaga kesehatan melihat rekam kondisi kesehatan pelajar untuk mendukung proses konsultasi.* | *US-08* |
| A09 | *Mengonfirmasi Jadwal Konsultasi* | *Tenaga kesehatan mengonfirmasi jadwal konsultasi yang diajukan pelajar.* | *US-09* |
